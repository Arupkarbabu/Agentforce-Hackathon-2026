...
export default class PromotionWizardStep3 extends LightningElement {
    ...
    restoreSelectionsFromState() {
        const stateStores = this.stateManager.getState().chosenStores || [];
    ...
    get promotionName() {
        return this.stateManager.getState().promotionName || 'Untitled Promotion';
    }

    get selectedProducts() {
        return this.stateManager.getState().chosenProducts || [];
    }
    ...
    allValid() {
        ...
        this.stateManager.updateStores(storesArray);
